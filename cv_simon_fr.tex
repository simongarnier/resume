...
\cventry{2015}{Développeur d'applications mobiles}{}{Greencopper, Montréal}{}{
  \begin{itemize}
    ...
    \item[-] Développement d'un utilitaire d'analyse donnant de la valeur au logs d'application
  \end{itemize}
}

\cventry{2014--2015}{Développeur backend et frontend}{}{Seevibes, Montréal}{}{
  \begin{itemize}
    \item[-] Ajout de fonctionnalité à une application Ruby on Rails
...
\cventry{2013}{Messager à vélo}{}{Les Messagerie du Grand Montréal}{}{
  Messager à vélo sous-contractant
}

%------------------------------------------------

\cventry{2008--2012}{Agent de terrain}{}{plusieurs festivals à Montréal}{}{
  Entretien et acceuil sur des sites évenementiels
  \newline
